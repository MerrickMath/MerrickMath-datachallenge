...
<p>
      <ul>
        ...
        <li> New Recurit: Complete Introduction to R, and take the in class test (200 XP) </li>   
        ...
        <li> R Lieutenant: Complete Intermediate R, and take the in class test (200 XP) </li>
      </ul> 
</p>
